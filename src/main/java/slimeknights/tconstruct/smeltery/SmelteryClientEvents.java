...
public class SmelteryClientEvents extends ClientEventBase {
  ...
  static void registerModelLoaders(RegisterGeometryLoaders event) {
    event.register(ResourceLocation.fromNamespaceAndPath(TConstruct.MOD_ID, "tank"), TankModel.LOADER);
    event.register(ResourceLocation.fromNamespaceAndPath(TConstruct.MOD_ID, "fluid_texture"), FluidTextureModel.LOADER);
  }
}
