  ...
  public static void init() {
    ...
    register("basic_armor", data -> {
      ...
      return (IToolItemFactory<ModifiableArmorItem>)(props, builder) -> {
        ...
        return add(ARMOR_ITEMS, new ModifiableArmorItem(material.armorMaterial(), slot, props, ToolDefinition.create(builder.getRegistryName())));
      };
    });
    ...
    register("multilayer_armor", data -> {
      ...
      return (IToolItemFactory<MultilayerArmorItem>)(props, builder) -> {
        DummyArmorMaterial material = new DummyArmorMaterial(name, sound);
        return add(ARMOR_ITEMS, new MultilayerArmorItem(material.armorMaterial(), slot, props, ToolDefinition.create(builder.getRegistryName())));
      };
    });
  }
