...
public class EquipmentChangeWatcher {
  ...
  public static void register() {
    FMLJavaModLoadingContext.get().getModEventBus().addListener(EventPriority.NORMAL, false, RegisterCapabilitiesEvent.class,
      event -> event.registerEntity(CAPABILITY, EntityType.PLAYER, (player, context) -> new PlayerLastEquipment((Player) player)));
