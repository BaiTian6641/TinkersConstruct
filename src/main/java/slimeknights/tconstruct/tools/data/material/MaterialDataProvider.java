...
public class MaterialDataProvider extends AbstractMaterialDataProvider {
  ...
  protected void addMaterials() {
    ...
    addMaterial(MaterialIds.treatedWood, 2, ORDER_COMPAT + ORDER_GENERAL, true, false,
      new OrCondition(List.of((ICondition)ConfigEnabledCondition.FORCE_INTEGRATION_MATERIALS, tagExistsCondition("treated_wood"), new TagFilledCondition<>(FluidTags.create(commonResource("creosote"))))));
