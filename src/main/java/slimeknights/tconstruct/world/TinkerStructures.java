...
public final class TinkerStructures extends TinkerModule {
   ...
   * Misc
   */
  public static final DeferredHolder<TreeDecoratorType<?>, TreeDecoratorType<?>> leaveVineDecorator = TREE_DECORATORS.register("leave_vines", () -> new TreeDecoratorType<>(LeaveVineDecorator.CODEC));
  public static final DeferredHolder<RootPlacerType<?>, RootPlacerType<?>> extraRootVariantPlacer = ROOT_PLACERS.register("extra_root_variants", () -> new RootPlacerType<>(ExtraRootVariantPlacer.CODEC));
