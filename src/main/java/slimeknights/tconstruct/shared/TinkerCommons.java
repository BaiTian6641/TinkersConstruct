...
public final class TinkerCommons extends TinkerModule {
  ...
  public static final DeferredHolder<IngredientType<?>, IngredientType<NoContainerIngredient>> NO_CONTAINER_INGREDIENT = INGREDIENT_TYPES.register("no_container", () -> new IngredientType<>(NoContainerIngredient.CODEC, NoContainerIngredient.STREAM_CODEC));
  public static final DeferredHolder<IngredientType<?>, IngredientType<BlockTagIngredient>> BLOCK_TAG_INGREDIENT = INGREDIENT_TYPES.register("block_tag", () -> new IngredientType<>(BlockTagIngredient.CODEC, BlockTagIngredient.STREAM_CODEC));
  ...
  void registerRecipeSerializers(RegisterEvent event) {
    if (event.getRegistryKey() == Registries.RECIPE_SERIALIZER) {
      // ConfigEnabledCondition is now codec-based and registered through LootItemConditionType.
      CriteriaTriggers.register("tconstruct:block_container_opened", CONTAINER_OPENED_TRIGGER);
