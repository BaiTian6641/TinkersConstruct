...
public final class TinkerMaterials extends TinkerModule {
  ...
  public static final DeferredHolder<IngredientType<?>, IngredientType<MaterialIngredient>> MATERIAL_INGREDIENT = INGREDIENT_TYPES.register("material", () -> new IngredientType<>(MaterialIngredient.CODEC, MaterialIngredient.STREAM_CODEC));
  public static final DeferredHolder<IngredientType<?>, IngredientType<MaterialValueIngredient>> MATERIAL_VALUE_INGREDIENT = INGREDIENT_TYPES.register("material_value", () -> new IngredientType<>(MaterialValueIngredient.CODEC, MaterialValueIngredient.STREAM_CODEC));
