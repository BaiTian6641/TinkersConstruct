...
public class TinkerAttributes {
  ...
  void addAttributes(EntityAttributeModificationEvent event) {
    // player attributes
    event.add(EntityType.PLAYER, USE_ITEM_SPEED.getDelegate());
    event.add(EntityType.PLAYER, CRITICAL_DAMAGE.getDelegate());
    event.add(EntityType.PLAYER, MINING_SPEED_MULTIPLIER.getDelegate());
    event.add(EntityType.PLAYER, EXPERIENCE_MULTIPLIER.getDelegate());
    event.add(EntityType.PLAYER, JUMP_COUNT.getDelegate());
    // general attributes
  ...
  private static void addToAll(EntityAttributeModificationEvent event, DeferredHolder<Attribute, Attribute> attribute, double defaultValue) {
    for (EntityType<? extends LivingEntity> entity : event.getTypes()) {
      event.add(entity, attribute.getDelegate(), defaultValue);
    }
  }
