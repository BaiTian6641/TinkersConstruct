...
public class TinkerDataCapability {
  ...
  /** Capability type */
  public static final EntityCapability<Holder, Void> CAPABILITY =
    EntityCapability.createVoid(TConstruct.getResource("modifier_data"), Holder.class);

  /** Registers this capability with the event bus */
  @SuppressWarnings("unchecked")
  public static void registerCapabilities(RegisterCapabilitiesEvent event) {
    for (EntityType<?> entityType : BuiltInRegistries.ENTITY_TYPE) {
      event.registerEntity(CAPABILITY, (EntityType<LivingEntity>) entityType,
        (entity, ctx) -> entity instanceof LivingEntity ? new Holder() : null);
    }
  }
