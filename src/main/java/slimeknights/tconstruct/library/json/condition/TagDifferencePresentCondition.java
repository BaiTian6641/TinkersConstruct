...
public class TagDifferencePresentCondition<T> implements ICondition {
  ...
  public static final MapCodec<TagDifferencePresentCondition<?>> SERIALIZER = RecordCodecBuilder.mapCodec(instance -> instance.group(
  ...
  ).apply(instance, TagDifferencePresentCondition::readGeneric));
  ...
  private static <T> TagDifferencePresentCondition<T> readGeneric(ResourceLocation registryId, ResourceLocation base, List<ResourceLocation> subtracted) {
