...
public class TagIntersectionPresentCondition<T> implements ICondition {
  ...
  public static final MapCodec<TagIntersectionPresentCondition<?>> SERIALIZER = RecordCodecBuilder.mapCodec(instance -> instance.group(
  ...
  ).apply(instance, TagIntersectionPresentCondition::readGeneric));
  ...
  private static <T> TagIntersectionPresentCondition<T> readGeneric(ResourceLocation registryId, List<ResourceLocation> names) {
