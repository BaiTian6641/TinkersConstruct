  ...
  public void load() {
    if (this.recipes == null) {
      ...
      if (modifier == ModifierManager.INSTANCE.getDefaultValue()) {
        ...
        this.recipes = RecipeHelper.getJEIRecipes(level.registryAccess(), level.getRecipeManager().getRecipes().stream().map(RecipeHolder::value), IDisplayModifierRecipe.class).stream()
