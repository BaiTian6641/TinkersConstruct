...
public class MaterialRecipeBuilder extends AbstractRecipeBuilder<MaterialRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer) {
    this.save(consumer, material.getLocation('_'));
  }
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    var advancement = this.buildOptionalAdvancement(id, "materials");
    consumer.accept(id, new MaterialRecipe(id, group, ingredient, value, needed, material, leftover), advancement);
  }
}
