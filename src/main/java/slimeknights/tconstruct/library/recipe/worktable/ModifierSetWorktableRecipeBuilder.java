...
public class ModifierSetWorktableRecipeBuilder extends AbstractSizedIngredientRecipeBuilder<ModifierSetWorktableRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    AdvancementHolder advancementId = buildOptionalAdvancement(id, "modifiers");
    consumer.accept(id, new ModifierSetWorktableRecipe(id, dataKey, inputs, tools, modifierPredicate, addToSet, allowTraits), advancementId);
  }
}
