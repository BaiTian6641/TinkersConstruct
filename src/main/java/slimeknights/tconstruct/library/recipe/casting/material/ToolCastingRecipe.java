  ...
  public List<IDisplayableCastingRecipe> getRecipes(RegistryAccess access) {
    if (multiRecipes == null) {
      ...
      if (requirements.isEmpty()) {
        ...
        CompoundTag displayTag = partSwapDisplay.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
        displayTag.putBoolean(TooltipUtil.KEY_DISPLAY, true);
        partSwapDisplay.set(DataComponents.CUSTOM_DATA, CustomData.of(displayTag));
