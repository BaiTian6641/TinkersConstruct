...
public class ContainerFillingRecipeBuilder extends AbstractRecipeBuilder<ContainerFillingRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    var advancement = this.buildOptionalAdvancement(id, "casting");
    Item container = BuiltInRegistries.ITEM.get(result);
    consumer.accept(id, new ContainerFillingRecipe(recipeSerializer, id, group, fluidAmount, container), advancement);
  }
}
