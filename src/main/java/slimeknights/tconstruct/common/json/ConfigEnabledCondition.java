...
public class ConfigEnabledCondition implements ICondition, LootItemCondition {
  ...
  public static final MapCodec<ConfigEnabledCondition> SERIALIZER = RecordCodecBuilder.mapCodec(instance -> instance.group(
    Codec.STRING.fieldOf("prop").forGetter(condition -> condition.configName)
  ).apply(instance, ConfigEnabledCondition::fromName));
  ...
  private static ConfigEnabledCondition fromName(String prop) {
